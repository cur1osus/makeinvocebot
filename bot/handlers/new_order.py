...
prompt = """Структурируй этот заказ в виде json для дальнейшей обработки и составления накладной, отправь только json без дополнительного текста и <think>, проставь стоимость по
этому списку:
